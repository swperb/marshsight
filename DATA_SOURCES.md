...
| Hunting units (game zones / WMAs) | State wildlife agencies (per state) | Public domain / public records | Direct ArcGIS REST per state. AR: AGFC deer zones. MS: MDWFP deer zones. LA: LDWF WMAs/refuges. MO: MDC conservation areas (via MSDIS). AL: WMAs (hosted public-record copy; official DCNR server unreachable) |
