...
| Hunting units (game zones / WMAs) | State wildlife agencies (per state) | Public domain / public records | Direct ArcGIS REST per state. AR: AGFC deer zones. AL: Wildlife Management Areas (hosted public-record copy; official DCNR server currently unreachable) |
